...
ini_set('display_errors', 1);
	...
	$sql = "SELECT username, firstname, lastname , email , phone , gender , name FROM prerna_user";
	...
	if ($result->num_rows > 0) 
	{
		while($row = $result->fetch_assoc()) 
		{
			...
			echo "Username: " . $row["username"]. "   Name: " . $row["firstname"]. " " . $row["lastname"]."   Phone: ".$row["phone"]."   Gender: ".$row["gender"];
